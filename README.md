...
- [x] GoogleTest 1.18 单元测试（58 个测试全通过）
...
- [x] `tools/demo_bitwise.cpp` / `demo_overflow.cpp` / `demo_cpu.cpp` 教学 demo
- [x] `docs/computer-science/` 六章基础文档

**下一步：** Phase 0.3 — 6502 汇编（助记符 / 机器码 / 汇编器 / 反汇编器）
...
├── CMakeLists.txt
├── docs/                学习文档
│   ├── computer-science/  二进制 / 十六进制 / 补码 / 位运算 / V flag / CPU
│   ├── architecture/      系统架构
│   ├── assembly/          6502 汇编
│   └── nes/               NES 硬件规范
├── src/
...
Phase 0.2 CPU 基础          [done] <-- 你在这里
Phase 0.3 6502 汇编         [next]
Phase 0.4 寻址模式
Phase 1   6502 CPU
Phase 2   NES Bus
